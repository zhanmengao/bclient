...
void Widget::InitToolBar()
{
    ...
    act[0] = new QAction(QIcon("../resources/browser.png"), "QToolBar", this);
    act[1] = new QAction(QIcon("../resources/calendar.png"), "QAction", this);
    ...
    toolbar->setGeometry(0,300,500,200);
}
